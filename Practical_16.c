...
ROLL NO : 25CE056
AIM : To write a C program to implement a simple game where the user plays against the computer. The game starts with 21 Matchsticks. The user is asked to pick 1, 2, 3, or 4 Matchsticks. After the user picks, the computer makes its pick. Who picks the last Matchstick loses the game.
*/  
