...
/*
    ...
    ROLL NO : 25CE056
    AIM : Write a C program to implement a library management system using functions to perform the following operations:
          a) Display book details
          b) Check availability
          c) Update inventory on borrowing/returning
          d) Fine calculation for late returns
*/
