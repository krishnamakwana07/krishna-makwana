...
ROLL NO :: 25CE56
AIM :: Write a C program to perform the following string operations without using built-in string functions:
      a. Length of the string
      b. Reverse of the string
      c. Compare two strings
      d. Copy one string to another
      e. Concatenation of two strings
      f. Convert to upper case
      g. Convert to lower case
      h. Capitalize each word in the string
