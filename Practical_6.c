...
ROLL NO : 25CE056
AIM : To write a C program to convert temperature from Celsius to Fahrenheit and Kelvin, Fahrenheit to Celsius and Kelvin, Kelvin to Celsius and Fahrenheit.
*/
